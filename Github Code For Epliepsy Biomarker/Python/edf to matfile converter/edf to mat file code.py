...
# ========================= USER SETTINGS ========================= #
INPUT_DIR       = r"F:\Research After Conference\task 69 edf to mat file conversion"       # <--- set your input folder
OUTPUT_DIR      = r"F:\Research After Conference\task 69 edf to mat file conversion\out"   # <--- set your output folder
