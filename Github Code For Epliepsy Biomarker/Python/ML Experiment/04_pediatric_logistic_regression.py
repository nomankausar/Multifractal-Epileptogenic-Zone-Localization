...
# -*- coding: utf-8 -*-
"""
Pediatric Logistic Regression — Patient-Grouped 10-Fold CV
...
3. Press Run.
4. Results are saved in outputs/pediatric_logistic_regression.
...
OUTPUT_DIR = Path(
    os.environ.get(
        "EZ_OUTPUT_DIR",
        str(SCRIPT_DIR / "outputs" / "pediatric_logistic_regression"),
    )
)
