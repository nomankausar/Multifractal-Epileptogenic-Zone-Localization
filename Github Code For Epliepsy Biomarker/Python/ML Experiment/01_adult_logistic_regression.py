...
# -*- coding: utf-8 -*-
"""
Adult Logistic Regression — Patient-Grouped 10-Fold CV
...
3. Press Run.
4. Results are saved in outputs/adult_logistic_regression.
...
OUTPUT_DIR = Path(
    os.environ.get(
        "EZ_OUTPUT_DIR",
        str(SCRIPT_DIR / "outputs" / "adult_logistic_regression"),
    )
)
